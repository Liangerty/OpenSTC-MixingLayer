...
class Block {
public:
  explicit Block(integer _mx, integer _my, integer _mz, integer _ngg, integer _id, const Parameter &parameter);
...
private:
  void read_grid(integer myid, const Parameter &parameter);
