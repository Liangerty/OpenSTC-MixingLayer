...
MPI_Offset create_tke_budget_file(Parameter &parameter, const Mesh &mesh, int n_block_ahead);

std::vector<int>
read_tke_budget_file(Parameter &parameter, const Mesh &mesh, int n_block_ahead, std::vector<Field> &field);
